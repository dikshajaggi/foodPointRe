...
const DishCard = () => {
  return (
    <>
      <div className='flex flex-col h-[270px] w-[150px] md:h-[300px] md:w-[250px] lg:h-[300px] lg:w-[250px] shadow shadow-gray-300 rounded-lg'>
        <img src = {dishImage} alt="dish-image" className = 'h-[60%] w-full object-cover rounded-t-lg' />
        <div className='flex flex-col justify-evenly px-1.5 pt-1'>
          ...
          <div className='flex justify-between text-md md:text-xl lg:text-xl items-center mt-4'>
            ...
            {/* <button className='rounded-md font-bold p-0.5 w-[60px] h-[25px] md:w-[60px] md:h-[35px] lg:w-[60px] lg:h-[35px] uppercase text-success border-1 border-success text-md md:text-xl lg:text-xl cursor-pointer'>ADD</button> */}
            <div className='flex items-center justify-evenly border-[2px] border-gray-300 text-md rounded-md h-[25px] w-[70px] md:h-[35px] lg:h-[35px] md:w-[90px] lg:w-[90px]'>
              <button><img src={remove} alt="remove-icon" className='h-4 w-4 md:h-6 md:w-6 lg:h-6 lg:w-6 cursor-pointer'/></button>
              <span className='text-success text-md md:text-xl lg:text-xl font-bold '>1</span>
              <button><img src={add} alt="add-icon" className='h-4 w-4 md:h-6 md:w-6 lg:h-6 lg:w-6 cursor-pointer'/></button>
            </div>
          </div>
        </div>
      </div>
